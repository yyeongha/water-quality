...
class GAIN():
  ...
  def build_discriminator(self):
    ...
    #d_w1 = K.expand_dims(self.D_W1, 0) # shape (114,57) ==> (1,114,57)
    #d_w2 = K.expand_dims(self.D_W2, 0) # shape (57,57) ==> (1,57,57)
    #d_w3 = K.expand_dims(self.D_W3, 0) # shape (57,57) ==> (1,57,57)
    #d_b1 = K.expand_dims(self.D_b1, 0) # shape (114,57) ==> (1,114,57)
    #d_b2 = K.expand_dims(self.D_b2, 0) # shape (57,57) ==> (1,57,57)
    #d_b3 = K.expand_dims(self.D_b3, 0) # shape (57,57) ==> (1,57,57)
    ...
    a = GDense(w = self.D_W1, b = self.D_b1)(inputs)
    #a = Dot(axes=1)([inputs, d_w1])
    #a = Add()([a, d_b1])
    a = ReLU()(a) # D_h1

    a = GDense(w = self.D_W2, b = self.D_b2)(a)
    a = ReLU()(a) # D_h2

    a = GDense(w = self.D_W3, b = self.D_b3)(a) # D_logit
    D_prob = Activation('sigmoid', name='generator_output')(a)

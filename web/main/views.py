...
def predict_run(request):
    ...
    try:
        ...
        print(e)
        return render(request, 'predict_run.html', {"return": "fail"})
    ...
    context = {"predict_cahrt": predict_cahrt, "predict_water": predict_water,
                                                "column": parameters['web_info']['columns'][key], "color": color,
                                                "rain_chart": rain_chart}
    return render(request, 'predict_run.html', context)
